...
.eqv  COUNTER         0xFFFF0013         # Byte value at address  : If one bit of this byte is set, the counter interruption is enable.
...
IsKeyMa:li    $t2, MASK_CAUSE_KEYMATRIX # if Cause value confirm Key Matrix..
        and   $at, $t1,$t2
